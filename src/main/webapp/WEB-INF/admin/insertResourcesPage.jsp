	...
	<div class="am-cf admin-main">
		...
		<div class=" admin-content">
			...
			<div class="admin-biaogelist">
				...
				<div class="fbneirong">
					<form   class="am-form"      action="${pageContext.request.contextPath}/resources/insertResources.action"
					method="post" enctype="multipart/form-data">
							...
							<div class="you">
								<select name="kcbh">
									...
									<c:forEach items="${kclist}" var="kc">
										<option value="${kc.kcbh}" id="${kc.kcbh}">${kc.kcname}</option>
									</c:forEach>
								</select>
							</div>
						</div>
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<input type="text" class="am-input-sm" name="resname" value="${resname }"
						...
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<input type="text" class="am-input-sm"  name="respf" value="${respf }"
						...
						<div class="am-form-group am-cf">
							...
							<input type="file" name="multipartFile"   accept="application/pdf,video/mp4" >
