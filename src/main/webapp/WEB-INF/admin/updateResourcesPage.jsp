	...
	<div class="am-cf admin-main">
		...
		<div class=" admin-content">
			...
			<div class="admin-biaogelist">
				...
				<div class="fbneirong">
					<form   class="am-form"      action="${pageContext.request.contextPath}/resources/updateResources.action"
							...
							<div class="you">
								<select name="kcbh">
									...
									<c:forEach items="${kclist}" var="kc">
										<option value="${kc.kcbh}"   <c:if test="${kc.kcbh==resources.kcbh }">selected</c:if>    id="${kc.kcbh}">${kc.kcname}</option>
									</c:forEach>
								</select>
							</div>
						</div>
						<div class="am-form-group am-cf">
							<div class="zuo">资源名称：</div>
							<div class="you">
								<input type="text" class="am-input-sm" name="resname" value="${resources.resname }"
									id="doc-ipt-pwd-1" placeholder="请输入资源名称">
							</div>
						</div>
						<div class="am-form-group am-cf">
							<div class="zuo">课程评分：</div>
							<div class="you">
							<input type="hidden" class="am-input-sm"  name="resid" value="${resources.resid }"
									id="doc-ipt-pwd-1" >
								<input type="text" class="am-input-sm"  name="respf" value="${resources.respf }"
									id="doc-ipt-pwd-1" placeholder="10以内">
							</div>
						</div>
