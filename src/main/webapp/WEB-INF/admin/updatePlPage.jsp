	...
	<div class="am-cf admin-main">
		...
		<div class=" admin-content">
			...
			<div class="admin-biaogelist">
				...
				<div class="fbneirong">
					<form   class="am-form"      action="${pageContext.request.contextPath}/pl/updatePl.action"
					method="post" >
						<div class="am-form-group am-cf">
							<div class="zuo">所属资源：</div>
							<div class="you">
								<select name="resid"       >
									<option value="">--请选择--</option>
									<c:forEach items="${resourceslist}" var="res">
										<option value="${res.resid}"   <c:if test="${res.resid==pl.resid }">selected</c:if>    id="${res.resid}">${res.resname}</option>
									</c:forEach>
								</select>
							</div>
						</div>
						<div class="am-form-group am-cf">
							<div class="zuo">评论用户：</div>
							<div class="you">
							<input type="hidden" class="am-input-sm" name="plid" value="${pl.plid}"
									id="doc-ipt-pwd-1" >
						...
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<input type="text" class="am-input-sm"  name="pf" value="${pl.pf}"
									id="doc-ipt-pwd-1" placeholder="请输入1-10">
							</div>
						</div>
						<div class="am-form-group am-cf">
							<div class="zuo">评论：</div>
							<div class="you">
								<input type="text" class="am-input-sm" name="plcontent"  value="${pl.plcontent}"
									id="doc-ipt-pwd-1" placeholder="请输入评论信息">
							</div>
						</div>
