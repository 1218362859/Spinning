...
<body>
						...
						<c:forEach items="${kclist}" var="kc">
							<tr>
								...
								<td><div class="am-btn-toolbar">
										<div class="am-btn-group am-btn-group-xs">
											<a href="${pageContext.request.contextPath }/kc/updateKcPage.action?kcbh=${kc.kcbh}"
												class="am-btn am-btn-default am-btn-xs am-text-warning  am-round">
												<span class="am-icon-pencil-square-o"></span>
											</a>
											<a type="button" onClick="return del()"
												href="${pageContext.request.contextPath }/kc/deleteKcByid.action?kcbh=${kc.kcbh}"
	...
	<script src="${pageContext.request.contextPath}/js/polyfill/rem.min.js">
											</script>
	<script
