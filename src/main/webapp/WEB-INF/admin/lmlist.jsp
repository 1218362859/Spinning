					...
					<table width="100%"
						...
						<thead>
							<tr class="am-success">
								...
								<th class="table-id">栏目编号</th>
								<th class="table-title">栏目名称</th>
								<th class="table-type">栏目状态</th>
						...
						<tbody>
							...
							<c:forEach items="${lmlist}" var="lm" >
								<tr>
									...
									<td>${lm.lmbh }</td>
									<td><a href="#">${lm.lmname }</a></td>
									<td>${ lm.lmstate}</td>
									<td><div class="am-btn-toolbar">
											<div class="am-btn-group am-btn-group-xs">
												<a href="${pageContext.request.contextPath }/lm/updateLmPage.action?lmbh=${lm.lmbh}"
													class="am-btn am-btn-default am-btn-xs am-text-warning  am-round">
													<span class="am-icon-pencil-square-o"></span>
												</a>
												<a type="button" onClick="return del()" 
												 href="${pageContext.request.contextPath }/lm/deletelmBylmbh.action?lmbh=${lm.lmbh}"
