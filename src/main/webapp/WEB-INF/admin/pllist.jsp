					...
					<table width="100%"
						...
						<thead>
							<tr class="am-success">
								...
								<th class="table-title">资源ID</th>
								<th class="table-type">评论用户</th>
								<th class="table-type">评分</th>
								<th class="table-type">评论日期</th>
							...
							<c:forEach items="${pllist}" var="pl" >
								<tr>
									...
									<td><div class="am-btn-toolbar">
											<div class="am-btn-group am-btn-group-xs">
												<a href="${pageContext.request.contextPath }/pl/updatePlPage.action?plid=${pl.plid}"
													class="am-btn am-btn-default am-btn-xs am-text-warning  am-round">
													<span class="am-icon-pencil-square-o"></span>
												</a>
												<a type="button" onClick="return del()" 
												 href="${pageContext.request.contextPath }/pl/deleteplByplid.action?plid=${pl.plid}"
