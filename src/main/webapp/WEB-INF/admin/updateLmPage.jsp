	...
	<div class="am-cf admin-main">
		...
		<div class=" admin-content">
			...
			<div class="admin-biaogelist">
				...
				<div class="fbneirong">
					<form   class="am-form"      action="${pageContext.request.contextPath}/lm/updateLm.action"
					method="post" >
						...
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<input type="text" class="am-input-sm" name="lmname" value="${lm.lmname}"
									id="doc-ipt-pwd-1" placeholder="请输入栏目名称">
							</div>
						</div>
						<div class="am-form-group am-cf">
							<div class="zuo">栏目状态：</div>
							<div class="you">
							<input type="hidden" class="am-input-sm"  name="lmbh"  value="${lm.lmbh}"
									id="doc-ipt-pwd-1" >
								<input type="text" class="am-input-sm"  name="lmstate"  value="${lm.lmstate}"
