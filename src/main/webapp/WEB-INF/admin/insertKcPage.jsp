	...
	<div class="am-cf admin-main">
		...
		<div class=" admin-content">
			...
			<div class="admin-biaogelist">
				...
				<div class="fbneirong">
					<form   class="am-form"      action="${pageContext.request.contextPath}/kc/insertKc.action"
					method="post" enctype="multipart/form-data">
							...
							<div class="you">
								<select name="lmbh"       >
									...
									<c:forEach items="${lmlist}" var="lm">
										<option value="${lm.lmbh}" id="${lm.lmbh}">${lm.lmname}</option>
									</c:forEach>
								</select>
							</div>
						</div>
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<input type="text" class="am-input-sm" name="kcname"  value="${kcname }"
									id="doc-ipt-pwd-1" placeholder="请输入课程名称">
							</div>
						</div>
						<div class="am-form-group am-cf">
							<div class="zuo">课程状态：</div>
							<div class="you">
								<input type="text" class="am-input-sm"  name="kcstate" value="${kcstate }"
									id="doc-ipt-pwd-1" placeholder="请输入1或0">
							</div>
						</div>
						<div class="am-form-group am-cf">
							<div class="zuo">课程信息：</div>
							<div class="you">
								<input type="text" class="am-input-sm" name="kcxx" value="${kcxx }"
									id="doc-ipt-pwd-1" placeholder="请输入课程信息">
							</div>
						</div>
						...
						<div class="am-form-group am-cf">
							...
							<div class="you" style="height: 45px;">
								<input type="text" class="am-input-sm" name="kcnd" value="${kcnd}"
									id="doc-ipt-pwd-1" placeholder="请输入课程难度  如中等">
						...
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<input type="hidden" class="am-input-sm" name="kczz" value="${user.username }"
									id="doc-ipt-pwd-1" placeholder="请输入课程作者">
							</div>
						</div>
