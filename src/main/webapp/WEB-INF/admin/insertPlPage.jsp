	...
	<div class="am-cf admin-main">
		...
		<div class=" admin-content">
			...
			<div class="admin-biaogelist">
				...
				<div class="fbneirong">
					<form   class="am-form"      action="${pageContext.request.contextPath}/pl/insertPl.action"
					method="post" >
							...
							<div class="you">
								<select name="resid"       >
									...
									<c:forEach items="${resourceslist}" var="res">
										<option value="${res.resid}" id="${res.resid}">${res.resname}</option>
									</c:forEach>
								</select>
							</div>
						</div>
						...
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<input type="text" class="am-input-sm"  name="pf" value="${pf}"
						...
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<input type="text" class="am-input-sm" name="plcontent"  value="${plcontent}"
