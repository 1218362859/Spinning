	...
	<div class="am-cf admin-main">
		...
		<div class=" admin-content">
			...
			<div class="admin-biaogelist">
				...
				<div class="fbneirong">
					<form   class="am-form"      action="${pageContext.request.contextPath}/user/updateUser.action"
					method="post" >
					<div class="am-form-group am-cf">
						...
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<input type="text" class="am-input-sm" name="password" value="${user.password }"
						...
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<select name="yhdj" >
									...
									<option value="1" <c:if test="${user.yhdj==1 }">selected</c:if>  >--普通用户--</option>
									<option value="2"    <c:if test="${user.yhdj==2 }">selected</c:if>     >--管理员--</option>
								</select>
							</div>
						</div>
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<select name="state"       >
									<option value="" >--请选择--</option>
									<option value="1" <c:if test="${user.state==1 }">selected</c:if> >--激活--</option>
									<option value="0" <c:if test="${user.state==0 }">selected</c:if>  >--未激活--</option>
								</select>
							</div>
						</div>
						<div class="am-form-group am-cf">
						...
						<div class="am-form-group am-cf">
							...
							<div class="you">
							<input type="hidden" class="am-input-sm" name="uid" value="${user.uid }"
									id="doc-ipt-pwd-1" >
								<input type="text" class="am-input-sm" name="uemail" value="${user.uemail }"
