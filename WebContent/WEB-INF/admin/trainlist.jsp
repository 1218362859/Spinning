...
<SCRIPT type="text/javascript">
	function find() {
		if (true) {
			...
			document.forms.form2.action = " ${pageContext.request.contextPath}/train/findTrainlist.action";
				...
				<ul>
					...
					<form id="form2" method="post">
						...
						<input type="text" name="site"
							...
							placeholder="部位"    value="${t.site }" />
							
							</li>
							<li >
								 <input
								type="text" name="user_id" style="width: 200px"
								class="am-form-field am-input-sm am-input-xm"
								placeholder="创建者ID" value="${t.user_id }"  />
						</li>
			...
			<form class="am-form am-g">
				<table width="100%" id="tb_3"
					...
					<thead>
						<tr class="am-success">
							...
							<th class="table-title">组数</th>
							<th class="table-type">每组次数</th>
							<th class="table-type">详细说明</th>
							<th class="table-type">创建者id</th>
							...
							<tr>
								...
								<td><div class="am-btn-toolbar">
										<div class="am-btn-group am-btn-group-xs">
											<a
												href="${pageContext.request.contextPath }/train/updatePage.action?id=${t.id}"
												class="am-btn am-btn-default am-btn-xs am-text-warning  am-round">
												<span class="am-icon-pencil-square-o"></span>
											</a> <a type="button" onClick="return del()"
												href="${pageContext.request.contextPath }/train/deleteTrain.action?id=${t.id}"
				...
				<ul class="am-pagination am-fr">
					...
					<c:if test="${queryByPage.pageNum!=1 }">
						<li><a
							href="${pageContext.request.contextPath }/train/findTrainlist.action?site=${t.site }&user_id=${t.user_id }&pageNo=1&pageSize=10">首页</a></li>
						<li><a
							href="${pageContext.request.contextPath }/train/findTrainlist.action?site=${t.site }&user_id=${t.user_id }&pageNo=${ queryByPage.pageNum-1}&pageSize=10">上一页</a></li>
					</c:if>

					<c:if test="${queryByPage.pageNum!= queryByPage.lastPage}">
						<li><a
							href="${pageContext.request.contextPath }/train/findTrainlist.action?site=${t.site }&user_id=${t.user_id }&pageNo=${ queryByPage.pageNum+1}&pageSize=10">下一页</a></li>
						<li><a
							href="${pageContext.request.contextPath }/train/findTrainlist.action?site=${t.site }&user_id=${t.user_id }&pageNo=${ queryByPage.lastPage}&pageSize=10">尾页</a></li>
					</c:if>
				</ul>
